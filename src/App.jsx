  ...
  return (
    ...
    <div class="dark:bg-[#181a1b] dark:text-white font-roboto ">
          ...
          <div class="grid p-8 gap-6">
            <div class="flex justify-center">
              <div class="bg-linear-to-r/longer from-indigo-500 to-teal-400 p-1 rounded-[90rem] shadow-2xl transition hover:scale-110 dark:shadow-white/15">
                <img src={profileIcon} class="rounded-[100rem] lg:w-3sx sm:w-2xs" />
              </div>  
            </div>
      ...
      <section class="grid p-10 gap-6 lg:grid-cols-2 sm:grid-cols-1">
        ...
        <div class="border-2 border-gray-200 shadow-2xl rounded-4xl p-4 dark:border-[#363b3d] dark:shadow-white/15">
        ...
        <div class="grid p-5 gap-6">
          <div class="border-2 border-gray-200 shadow-2xl rounded-4xl p-4 text-center dark:border-[#363b3d] dark:shadow-white/15">
            ...
            <div class="grid gap-5 p-6 lg:grid-cols-3 sm:grid-cols-1">
              <div class="border-3 shadow-2xl border-gray-100 rounded-2xl p-6 dark:border-[#363b3d] dark:shadow-white/5">
      ...
      <section class="pb-20">
            <div class="grid p-5 gap-6">
              <div class="grid gap-10 text-center justify-center">
                ...
                <div class="border-2 border-gray-200 shadow-2xl rounded-xl p-4 text-center max-w-fit transition dark:border-[#363b3d] dark:shadow-white/15 hover:scale-110 hover:bg-white hover:text-black hover:dark:shadow-black">
